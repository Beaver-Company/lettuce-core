...
public interface NodeSelectionStreamAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xclaim(K key, Consumer consumer, XClaimArgs args, String... messageIds);
     ...
     */
    AsyncExecutions<String> xgroupCreate(K key, String group, String offset);
     ...
     */
    AsyncExecutions<List<Object>> xpending(K key, String group);
     ...
     */
    AsyncExecutions<List<Object>> xpending(K key, String group, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xreadgroup(Consumer consumer, XReadArgs args, StreamOffset<K>... streams);
}
