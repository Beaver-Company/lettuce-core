...
public interface RedisStreamAsyncCommands<K, V> {
     ...
     */
    RedisFuture<List<StreamMessage<K, V>>> xclaim(K key, Consumer consumer, XClaimArgs args, String... messageIds);
     ...
     */
    RedisFuture<Boolean> xgroupDelconsumer(K key, Consumer consumer);
     ...
     */
    RedisFuture<Boolean> xgroupSetid(K key, String group, String offset);
     ...
     */
    RedisFuture<List<Object>> xpending(K key, String group);
     ...
     */
    RedisFuture<List<Object>> xpending(K key, String group, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    RedisFuture<List<StreamMessage<K, V>>> xreadgroup(Consumer consumer, StreamOffset<K>... streams);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    RedisFuture<List<StreamMessage<K, V>>> xreadgroup(Consumer consumer, XReadArgs args, StreamOffset<K>... streams);
}
